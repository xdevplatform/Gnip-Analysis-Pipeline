...
def add_segment(user_ids, segment_name, max_upload_size = 100000):
    ...
    if segment_id is None:
        ...
        logger.info('segment_creation_resonse text:\n' + segment_creation_response.text)
        ...
        logger.info('segment_post_response text:\n' + segment_post_ids.text)
...
def query_audience(unique_id, groupings):
    ...
    logger.info('audience_query_response text:\n' + audience_query_response.text)
    ...
    if audience_id is None:
        ...
        logger.info('audience_post JSON response:\n' + str(audience_post.json()))
